// Script simplificado para crear planes usando la API
const BASE_URL = 'http://localhost:5000/api';
const CLIENT_ID = '68812786d6a07da255dfc973';

// Datos de autenticación del cliente (para crear sus propios planes)
...
async function createPlansSimple() {
  try {
    ...
    // 4. Verificar los planes creados
